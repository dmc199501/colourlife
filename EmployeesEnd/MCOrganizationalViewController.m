//
//  MCOrganizationalViewController.m
//  EmployeesEnd
//
...
@interface MCOrganizationalViewController ()

@end

@implementation MCOrganizationalViewController
- (id)init
{
    self = [super init];
    if (self)
...
- (void)getOrganizational{
    NSMutableDictionary *sendDictionary = [NSMutableDictionary dictionary];
    if (self.type == 11) {
        [sendDictionary setValue:_orgString forKey:@"orgID"];
    }else{
