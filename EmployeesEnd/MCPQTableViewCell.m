...
@implementation MCPQTableViewCell
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self)
    {
        ...
        UILabel *label4 = [[UILabel alloc]initWithFrame:CGRectMake(20, 196, SCREEN_WIDTH-40, 20)];
        label4.text = @"片区总监调剂奖金包";
        ...
        _PQtotalLabel = [[UILabel alloc]initWithFrame:CGRectMake(SCREEN_WIDTH-212.5, 196, 200, 20)];
        
        _PQtotalLabel.textColor = [UIColor colorWithRed:244 / 255.0 green:52 / 255.0 blue:61/ 255.0 alpha:1];
        _PQtotalLabel.backgroundColor = [UIColor clearColor];
        _PQtotalLabel.textAlignment = NSTextAlignmentRight;
        [_PQtotalLabel setFont:[UIFont systemFontOfSize:18]];
        _PQtotalLabel.text = @"";
        [self addSubview:_PQtotalLabel];
        
        UILabel *label5 = [[UILabel alloc]initWithFrame:CGRectMake(20, 246, SCREEN_WIDTH/3, 20)];
        label5.text = @"总奖金包";
        ...
        _totalLabel = [[UILabel alloc]initWithFrame:CGRectMake(SCREEN_WIDTH-212.5, 246, 200, 20)];
        ...
        UIView *garView = [[UIView alloc]initWithFrame:CGRectMake(0, 281, SCREEN_WIDTH, 10)];
...
- (void)detailss:(UIButton *)button{
    ...
    if ([_delegate respondsToSelector:@selector(MCPQTableViewCell:details:)])
    {
        [_delegate MCPQTableViewCell:self details:button];
    }
}
- (void)awakeFromNib {
    [super awakeFromNib];
