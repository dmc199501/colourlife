...
@interface MCrelatedViewController ()<UISearchBarDelegate,UITableViewDelegate,UITableViewDataSource>
...
@implementation MCrelatedViewController
- (id)init
{
    self = [super init];
    if (self)
...
- (void)viewDidLoad {
        ...
        self.navigationItem.title = @"相关联系人";
